...
<html lang="en">
  ...
  <meta property="fb:app_id" content="1401488693436528">
    ...
    <meta content="https://avatars3.githubusercontent.com/u/21689064?v=4&amp;s=400" property="og:image" /><meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="android-Marvell/android_device_samsung_degaswifi" property="og:title" /><meta content="https://github.com/android-Marvell/android_device_samsung_degaswifi" property="og:url" /><meta content="Contribute to android_device_samsung_degaswifi development by creating an account on GitHub." property="og:description" />

  <link rel="assets" href="https://assets-cdn.github.com/">
  
  <meta name="pjax-timeout" content="1000">
  
  <meta name="request-id" content="708A:2FF9:5D9FD68:AD2089A:59957D84" data-pjax-transient>
...
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta name="user-login" content="">
    ...
    <meta name="js-proxy-site-detection-payload" content="">


  <meta name="html-safe-nonce" content="14cc9ac0a874b05c4e0c26f76f7d0bb688f55bc1">
...
<meta name="theme-color" content="#1e2327">
  ...
  <div class="container clearfix">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/site/dismiss_unsupported_browser" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="wBCREGX1VlgIzMXC59Rf8t29kv+h6D5YROD6ffDiUD9tPYOGdfGrznbbVW5nwuPDK7hJEYwluyc6fRmBIk5JRQ==" /></div>
      ...
      <input type="text"
        ...
        <span class="d-inline-block">
            <div class="header-navlink px-0 py-2 m-0">
              <a class="text-bold text-white no-underline" href="/login?return_to=%2Fandroid-Marvell%2Fandroid_device_samsung_degaswifi%2Fblob%2Fkk4.4%2Faosp_degaswifi.mk" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
  ...
  <li>
      <a href="/login?return_to=%2Fandroid-Marvell%2Fandroid_device_samsung_degaswifi"
    class="btn btn-sm btn-with-count tooltipped tooltipped-n"
    aria-label="You must be signed in to watch a repository" rel="nofollow">
    <svg aria-hidden="true" class="octicon octicon-eye" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M8.06 2C3 2 0 8 0 8s3 6 8.06 6C13 14 16 8 16 8s-3-6-7.94-6zM8 12c-2.2 0-4-1.78-4-4 0-2.2 1.8-4 4-4 2.22 0 4 1.8 4 4 0 2.22-1.78 4-4 4zm2-4c0 1.11-.89 2-2 2-1.11 0-2-.89-2-2 0-1.11.89-2 2-2 1.11 0 2 .89 2 2z"/></svg>
    Watch
  </a>
  <a class="social-count" href="/android-Marvell/android_device_samsung_degaswifi/watchers"
  ...
  <li>
    ...
    <a class="social-count js-social-count" href="/android-Marvell/android_device_samsung_degaswifi/stargazers"
  ...
  <li>
    ...
    <a href="/android-Marvell/android_device_samsung_degaswifi/network" class="social-count"
  ...
  <span class="author" itemprop="author"><a href="/android-Marvell" class="url fn" rel="author">android-Marvell</a></span><!--
--><span class="path-divider">/</span><!--
--><strong itemprop="name"><a href="/android-Marvell/android_device_samsung_degaswifi" data-pjax="#js-repo-pjax-container">android_device_samsung_degaswifi</a></strong>
...
<nav class="reponav js-repo-nav js-sidenav-container-pjax"
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a href="/android-Marvell/android_device_samsung_degaswifi" class="js-selected-navigation-item selected reponav-item" data-hotkey="g c" data-selected-links="repo_source repo_downloads repo_commits repo_releases repo_tags repo_branches /android-Marvell/android_device_samsung_degaswifi" itemprop="url">
    ...
    <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
      <a href="/android-Marvell/android_device_samsung_degaswifi/issues" class="js-selected-navigation-item reponav-item" data-hotkey="g i" data-selected-links="repo_issues repo_labels repo_milestones /android-Marvell/android_device_samsung_degaswifi/issues" itemprop="url">
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a href="/android-Marvell/android_device_samsung_degaswifi/pulls" class="js-selected-navigation-item reponav-item" data-hotkey="g p" data-selected-links="repo_pulls /android-Marvell/android_device_samsung_degaswifi/pulls" itemprop="url">
    ...
    <a href="/android-Marvell/android_device_samsung_degaswifi/projects" class="js-selected-navigation-item reponav-item" data-selected-links="repo_projects new_repo_project repo_project /android-Marvell/android_device_samsung_degaswifi/projects">
    ...
    <div class="reponav-dropdown js-menu-container">
      ...
      <div class="dropdown-menu-content js-menu-content">
        <div class="dropdown-menu dropdown-menu-sw">
          <a class="dropdown-item" href="/android-Marvell/android_device_samsung_degaswifi/pulse" data-skip-pjax>
            <svg aria-hidden="true" class="octicon octicon-pulse" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path fill-rule="evenodd" d="M11.5 8L8.8 5.4 6.6 8.5 5.5 1.6 2.38 8H0v2h3.6l.9-1.8.9 5.4L9 8.5l1.6 1.5H14V8z"/></svg>
            Pulse
          </a>
          <a class="dropdown-item" href="/android-Marvell/android_device_samsung_degaswifi/graphs" data-skip-pjax>
...
<div class="container new-discussion-timeline experiment-repo-nav">
  ...
  <a href="/android-Marvell/android_device_samsung_degaswifi/blob/892fffdc57630c4c0fbce68ada1813e92ba5ff9c/aosp_degaswifi.mk" class="d-none js-permalink-shortcut" data-hotkey="y">Permalink</a>

  <!-- blob contrib key: blob_contributors:v21:85e4ed63357254b6b264acc2407d2d5f -->
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  ...
  <div class="select-menu-modal-holder js-menu-content js-navigation-container" data-pjax>
    ...
    <div class="BtnGroup float-right">
      <a href="/android-Marvell/android_device_samsung_degaswifi/find/kk4.4"
    ...
    <div class="breadcrumb js-zeroclipboard-target">
      <span class="repo-root js-repo-root"><span class="js-path-segment"><a href="/android-Marvell/android_device_samsung_degaswifi"><span>android_device_samsung_degaswifi</span></a></span></span><span class="separator">/</span><strong class="final-path">aosp_degaswifi.mk</strong>
    </div>
  </div>


  <include-fragment class="commit-tease" src="/android-Marvell/android_device_samsung_degaswifi/contributors/kk4.4/aosp_degaswifi.mk">
    <div>
  ...
  <div itemprop="text" class="blob-wrapper data type-makefile">
      ...
      <tr>
        ...
        <td id="LC17" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span class="pl-c">#</span> Inherit Product Configurations</span></td>
      </tr>
      <tr>
        <td id="L18" class="blob-num js-line-number" data-line-number="18"></td>
        <td id="LC18" class="blob-code blob-code-inner js-file-line">$(call inherit-product, $(SRC_TARGET_DIR)/product/aosp_base.mk)</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC20" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span class="pl-c">#</span> Inherit device configuration</span></td>
      </tr>
      <tr>
        <td id="L21" class="blob-num js-line-number" data-line-number="21"></td>
        <td id="LC21" class="blob-code blob-code-inner js-file-line">$(call inherit-product, $(LOCAL_PATH)/device.mk)</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC23" class="blob-code blob-code-inner js-file-line"><span class="pl-smi">PRODUCT_NAME</span> := aosp_degaswifi</td>
      </tr>
      <tr>
        <td id="L24" class="blob-num js-line-number" data-line-number="24"></td>
        <td id="LC24" class="blob-code blob-code-inner js-file-line"><span class="pl-smi">PRODUCT_DEVICE</span> := degaswifi</td>
      </tr>
      <tr>
        <td id="L25" class="blob-num js-line-number" data-line-number="25"></td>
        <td id="LC25" class="blob-code blob-code-inner js-file-line"><span class="pl-smi">PRODUCT_MODEL</span> := SM-T230</td>
      </tr>
      <tr>
        <td id="L26" class="blob-num js-line-number" data-line-number="26"></td>
        <td id="LC26" class="blob-code blob-code-inner js-file-line"><span class="pl-smi">PRODUCT_BRAND</span> := samsung</td>
      </tr>
      <tr>
        <td id="L27" class="blob-num js-line-number" data-line-number="27"></td>
        <td id="LC27" class="blob-code blob-code-inner js-file-line"><span class="pl-smi">PRODUCT_MANUFACTURER</span> := samsung</td>
      </tr>
</table>
    ...
    <div class="dropdown-menu-content js-menu-content" id="inline-file-actions">
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2">
        ...
        <li><a class="js-zeroclipboard dropdown-item" id= "js-copy-permalink" style="cursor:pointer;" data-original-text="Copy permalink">Copy permalink</a></li>
          <li><a href="/android-Marvell/android_device_samsung_degaswifi/issues/new" class="dropdown-item" id="js-new-issue">Open new issue</a></li>
      </ul>
    </div>
  </div>
...
<div class="container-lg site-footer-container">
  <div class="site-footer " role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2017 <span title="0.17905s from unicorn-415328807-r1jf7">GitHub</span>, Inc.</li>
